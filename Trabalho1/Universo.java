...
public class Universo {
    ...
    //TAMANHO DO UNIVERSO (X) BASEADO NA DISTANCIA MÁXIMA: 5+D + (D-2)
    //TAMANHO DO UNIVERSO (Y) BASEADO NA DISTANCIA MÁXIMA: 2*D+2
    ...
    public void printUniverso(Planeta planetasLista[], int size){
        ...
        for(int y = 0;y<size;y++){
            System.out.println(Main.BG_BLUE+planetasLista[y].Nome+Main.BG_RESET+" \\ Anos: "+planetasLista[y].anoAtual+" \\ Dias: "+planetasLista[y].diaAtual+" \\ Horas: "+planetasLista[y].horaAtual+" \\ Velocidade de Translação Aproximada: "+planetasLista[y].getVelTranslacao());
        }
    }
